export default function Passkey({ name, id, creationDate, onRename, onDelete }: { name: string, id: string, creationDate: Date, onRename: (passkeyId: string) => void, onDelete: (passkeyId: string) => void }) {
    return (
        <div className="passkey-container py-4 px-6 flex bg-neutral-200 dark:bg-zinc-700 shadow justify-betweenitems-center rounded-3xl md:max-w-[22rem] md:min-w-[22rem] w-full transition-all duration-200">
