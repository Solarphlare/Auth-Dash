...
export default function Navbar() {
    return (
        <nav className="flex fixed w-full justify-between py-3 px-8 backdrop-blur-lg bg-neutral-100/60 dark:bg-zinc-900/60 transition duration-200" id="navbar">
            ...
            <img src={headerIcon} className="rounded-full w-8 h-8 lg:hover:shadow-lg lg:hover:scale-110 lg:active:scale-90 active:scale-90 shadow cursor-pointer transition duration-200" alt="" id="home-button" />
